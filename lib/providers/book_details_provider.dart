...
class BookDetailsProvider with ChangeNotifier {
  ...
  Future<BookDetails> getBookDetails(int bkId) async {
    List<Author> bookAuthors = []; // Initialize bookAuthors as an empty list
    List<Genre> bookGenres = []; // Initialize bookGenres as an empty list
    List<BookReview> bookReviews =
        []; // Initialize bookReviews as an empty list
    ...
    await Future.wait<void>([
      (() async =>
          bookAuthors = await _publishesProvider.getBookAuthors(bkId))(),
