...
class IssuesProvider with ChangeNotifier {
  ...
  UnmodifiableMapView<int, MemberBookIssue> get memberIssuesMap =>
      UnmodifiableMapView(_memberIssues);

  UnmodifiableListView<MemberBookIssue> get memberIssues =>
      UnmodifiableListView(_memberIssues.values.toList().reversed);

  IssuesProvider({@required dataRepository, required this.currentMId})
