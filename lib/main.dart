  ...
  Widget build(BuildContext context) {
    return Consumer<MembersProvider>(
      builder: (_, auth, __) {
        if (!auth.loggedIn)
          return MaterialApp(
            ...
            theme: ThemeData(
              ...
              textTheme: GoogleFonts.literataTextTheme().copyWith(
                headline1: TextStyle(
                  fontSize: 50,
                  letterSpacing: .5,
        ...
        return MainApp(
          key: UniqueKey(), // Example of providing a Key
          membersProvider: auth,
        );
      },
    );
  }
    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider<GenresProvider>(
          create: (_) =>
              GenresProvider(dataRepository: DataRepository.instance),
        ),
        ChangeNotifierProvider<PublishesProvider>(
            create: (_) =>
                PublishesProvider(dataRepository: DataRepository.instance)),
        ChangeNotifierProvider<ReviewsProvider>(
          create: (_) =>
              ReviewsProvider(dataRepository: DataRepository.instance),
        ),
        ChangeNotifierProxyProvider3<PublishesProvider, GenresProvider,
            ReviewsProvider, BookDetailsProvider>(
          create: (_) => BookDetailsProvider(
            publishesProvider: null,
            genresProvider: null,
            reviewsProvider: null,
          ),
          update: (ctx, pProv, gProv, rProv, prevBkDetails) =>
              BookDetailsProvider(
        ...
        ChangeNotifierProxyProvider3<PublishesProvider, GenresProvider,
            ReviewsProvider, AuthorDetailsProvider>(
        ...
        ChangeNotifierProvider<IssuesProvider>(
          create: (_) => IssuesProvider(
              ...
              currentMId: membersProvider.currentMId),
        ),
      ],
      child: MaterialApp(
        debugShowCheckedModeBanner: false,
        ...
        initialRoute: PageType.PROFILE.name,
        routes: {
